...
const PublisherTable = ({ publishers, meta }: Props) => {
  ...
  const handleDelete = async (publisher: Publisher) => {
    Swal.fire({
      title: "Warning",
      text: "Do you want to delete this publisher?",
      titleText: publisher.name,
      icon: "warning",
      ...
      if (result.isConfirmed) {
        useAxiosWithAuth
          .delete(`${PUBLISHERS}/delete/${publisher.id}`)
          .then(() => {
            Swal.fire({
              title: "Sucess",
              ...
              >
                ...
                <TableCell className="" align="right">
                  ...
                  <Tooltip title="Delete">
                    <Button onClick={() => handleDelete(publisher)}>
                      <DeleteOutlineIcon />
                    </Button>
                  </Tooltip>
                </TableCell>
