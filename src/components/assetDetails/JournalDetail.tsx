...
const JournalDetail = ({ asset }: Props) => {
    ...
    <div>
      ...
      <CustomTabPanel value={value} index={0}>
        <div className="grid grid-cols-1 md:grid-cols-2 w-full p-4">
          ...
          <p>
            <span className="font-bold">Volume No: </span>
            <span>{asset.volume_no}</span>
          </p>
          <p>
            <span className="font-bold">Version No: </span>
            <span>{asset.version_no}</span>
          </p>
          <p>
          ...
          <p>
            <span className="font-bold">Publisher Date: </span>
            <span>{asset.publishing_date}</span>
          </p>
          <p>
      ...
      <div className="flex justify-end p-4 space-x-4">
        <Button variant="outlined" LinkComponent={Link} href="/journals">
          Back
        </Button>
        {!asset.is_available && (
          <Button
            variant="contained"
            LinkComponent={Link}
            href={`/journals/reissuance/${asset.id}`}
          >
            Re-issue
          </Button>
        )}
        {asset.is_available && (
          <Button
            variant="contained"
            LinkComponent={Link}
            href={`/journals/issuance/${asset.id}`}
          >
            Issue
          </Button>
        )}
